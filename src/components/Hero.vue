...
<template>
  <section class="relative overflow-hidden bg-violet-800 text-white py-16 md:py-24">
    <!-- Imagem de fundo -->
    <div
    ...
    <div class="absolute inset-0 bg-violet-900/70 z-10"></div>
    ...
    <div class="container mx-auto px-4 relative z-20">
      <div class="flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="md:w-1/2 flex justify-center" data-aos="fade-left">
          <div class="relative">
            <!-- Texto em destaque sobreposta à imagem -->
    ...
    <div
      class="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-white to-transparent z-30"
    ></div>
  </section>
</template>
